...
import { signup, login, getFcmToken, verifyEmail, sendResetCode, resetPassword, verifyCode, resendVerificationCode } from "../../controllers/users/auth";
import { catchAsync } from "../../utils/catchAsync";
import { validate } from "../../middlewares/validation";
import { loginSchema, sendResetCodeSchema, signupSchema, verifyEmailSchema, resetPasswordSchema, checkResetCodeSchema, } from "../../validators/users/auth";
...
route.post("/verify-email", validate(verifyEmailSchema), catchAsync(verifyEmail));
