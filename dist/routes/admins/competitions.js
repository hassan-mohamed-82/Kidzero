...
import { getCompetition, getAllCompetitions, getCompetitionImages, getCompetitionUsers, createCompetition, updateCompetition, deleteCompetition, removeCompetitionUser, } from "../../controllers/admin/competitions";
import { createCompetitionSchema, updateCompetitionSchema, removeUserSchema, } from "../../validators/admin/competitions";
...
router.delete("/:id/users/:userId", validate(removeUserSchema), catchAsync(removeCompetitionUser));
