...
import { createPopUp, deletePopUp, updatePopUp, getAllPopUps, getPopUpById, getAllAppPages, createAppPage, updateAppPage, deleteAppPage, getAppPageById, } from "../../controllers/admin/popUps";
import { validate } from "../../middlewares/validation";
import { catchAsync } from "../../utils/catchAsync";
import { createPopUpSchema, updatePopUpSchema, } from "../../validators/admin/popUps";
const router = Router();
router
    .route("/Apppages")
