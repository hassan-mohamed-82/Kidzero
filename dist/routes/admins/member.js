...
import { createMember, getAllMembers, getMember, updateMember, deleteMember, } from "../../controllers/admin/member";
import { catchAsync } from "../../utils/catchAsync";
import { validate } from "../../middlewares/validation";
import { CreateMemberSchema, UpdateMemberSchema } from "../../validators/admin/member";
const router = Router();
router
    .route("/")
