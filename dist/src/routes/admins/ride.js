...
router.get("/occurrence/:occurrenceId", (0, checkpermission_1.checkPermission)("rides", "View"), (0, catchAsync_1.catchAsync)(ride_1.getOccurrenceDetails));
router.put("/occurrence/:occurrenceId/status", (0, checkpermission_1.checkPermission)("rides", "Edit"), (0, catchAsync_1.catchAsync)(ride_1.updateOccurrenceStatus));
// ✅ CRUD Routes
