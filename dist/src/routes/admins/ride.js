...
router.get("/upcoming", (0, catchAsync_1.catchAsync)(ride_1.getUpcomingRides));
...
router.get("/occurrence/:occurrenceId", (0, catchAsync_1.catchAsync)(ride_1.getOccurrenceDetails));
router.put("/occurrence/:occurrenceId/status", (0, catchAsync_1.catchAsync)(ride_1.updateOccurrenceStatus));
// ✅ CRUD Routes
router.post("/", (0, validation_1.validate)(ride_2.createRideSchema), (0, catchAsync_1.catchAsync)(ride_1.createRide));
router.get("/", (0, catchAsync_1.catchAsync)(ride_1.getAllRides));
