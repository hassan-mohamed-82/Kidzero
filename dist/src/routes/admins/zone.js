...
// ✅ Create Zone
router.post("/", (0, validation_1.validate)(zone_2.createZoneSchema), (0, catchAsync_1.catchAsync)(zone_1.createZone));
// ✅ Get All Zones
router.get("/", (0, catchAsync_1.catchAsync)(zone_1.getZones));
// ✅ Get Zone By ID
router.get("/:id", (0, catchAsync_1.catchAsync)(zone_1.getZoneById));
// ✅ Update Zone
router.put("/:id", (0, validation_1.validate)(zone_2.updateZoneSchema), (0, catchAsync_1.catchAsync)(zone_1.updateZone));
// ✅ Delete Zone
