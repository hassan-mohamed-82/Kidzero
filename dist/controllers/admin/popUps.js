...
export const createPopUp = async (req, res) => {
    ...
    await db.transaction(async (tx) => {
        ...
        await tx.insert(popUpsPages).values(pageIds.map((pageId) => ({
            id: uuidv4(),
            imageId: id,
            pageId,
        })));
...
export const getAllPopUps = async (_req, res) => {
