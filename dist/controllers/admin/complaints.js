...
export const getAllComplaintsCategory = async (req, res) => {
    const data = await db
        .select()
...
export const getComplaintsCategory = async (req, res) => {
    const { id } = req.params;
    const [data] = await db
        .select()
        .from(complaintsCategory)
...
export const createComplaintsCategory = async (req, res) => {
...
export const deleteComplaintsCategory = async (req, res) => {
    const { id } = req.params;
...
export const updateComplaintsCategory = async (req, res) => {
    const { id } = req.params;
    const { name, description } = req.body;
    const [category] = await db
        .select()
...
export const makeComplaintSeen = async (req, res) => {
